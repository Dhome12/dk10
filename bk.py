...
#boy = LineClient()
boy = LineClient(authToken="ECzqfwylV1HkKwOgegnf.7ejwPz7hhPjfA23WJ1YOZW.KfAz0vPc/s7yy1TPETtswJwBz60YyWiUKZoDJIimt0c=")
channel = LineChannel(boy,boy.server.CHANNEL_ID['LINE_TIMELINE'])
boy.log("Auth Token : " + str(boy.authToken))
print ("Welcome login k1")  
#k1 = LineClient()
k1 = LineClient(authToken="ECBt5zXue6LzRRPkzk00.KDxryEctushMixYB2tqq8a.7MDgUr1pN5lTnscvQemXxkLp7e4BgRhF2PsCKtFmoro=")
channel = LineChannel(k1,k1.server.CHANNEL_ID['LINE_TIMELINE'])
k1.log("Auth Token : " + str(k1.authToken))
print ("Welcome login k2")  
#k2 = LineClient()
k2 = LineClient(authToken="ECnrwrgPGIfZYeDAuzy7.XyqRl2wN7JgmhVtSwdySHW.qJ9tPAtS+1nCum+cI2gjO69XjG4AB12woKbwb8pvSmY=")
channel = LineChannel(k2,k2.server.CHANNEL_ID['LINE_TIMELINE'])
k2.log("Auth Token : " + str(k2.authToken))
print ("Welcome login k3")  
#k3 = LineClient()
k3 = LineClient(authToken="ECAqwOAkGPmnhvEmj1Jf./vSiiTuUuLcD+1Saj5ZuNW.FzcLv6/Qxmg72gwicXSyOxiBFV01LSjzTeEiISHfcBw=")
channel = LineChannel(k3,k3.server.CHANNEL_ID['LINE_TIMELINE'])
k3.log("Auth Token : " + str(k3.authToken))
print ("Welcome login k4")  
#k4 = LineClient()
k4 = LineClient(authToken="ECKzRcU12gZD65uikG84.b7JTGnuMPARaE3cJcJZ3Ha.ihSftIWb7AEL8ufRcSU9jcZTN1AiutpojGwMLIusO1g=")
channel = LineChannel(k4,k4.server.CHANNEL_ID['LINE_TIMELINE'])
k4.log("Auth Token : " + str(k4.authToken))
print ("Welcome login k5")  
#k5 = LineClient()
k5 = LineClient(authToken="ECjv3lJW2xMLSwwCRus9.5rCPn1fJmkDjbG2Uwg9E/q.+OdK41rXyeLRWkGelOG6Uk2ydbT/vVYVg9ccGesi93M=")
channel = LineChannel(k5,k5.server.CHANNEL_ID['LINE_TIMELINE'])
k5.log("Auth Token : " + str(k5.authToken))
print ("Welcome login k6")  
#k6 = LineClient()
k6 = LineClient(authToken="ECQ0byMVcx6O0FZ3Ttne.XpLYSQ+SXsk7sgv1s+Ml3G./3NhDkrdWv1PdlVFmQdWXjSqYA3CEIDgA0fu+2W3ySM=")
channel = LineChannel(k6,k6.server.CHANNEL_ID['LINE_TIMELINE'])
k6.log("Auth Token : " + str(k6.authToken))
print ("Welcome login k7")  
#k7 = LineClient()
k7 = LineClient(authToken="ECYGlOmwkqhETpn6NVwc.FXeH1zqx1Cx5fWaPEzCl+a.pcCmI4hQZIfEO6b0N+6y2ysZUNKlACAsSPHJhFv8MLQ=")
channel = LineChannel(k7,k7.server.CHANNEL_ID['LINE_TIMELINE'])
k7.log("Auth Token : " + str(k7.authToken))
print ("Welcome login k8")  
#k8 = LineClient()
k8 = LineClient(authToken="ECc7ogsl5DvHSixVTmi8.QVXPIKhd0ncZ47k+nVqhAa.Qvu57BdgrF9fVLvukIP913m7Dvbrybd+IW6rduOKdf4=")
channel = LineChannel(k8,k8.server.CHANNEL_ID['LINE_TIMELINE'])
k8.log("Auth Token : " + str(k8.authToken))
print ("Welcome login k9")  
#k9 = LineClient()
k9 = LineClient(authToken="ECFH8GpO2sldTCcefA5c.p9istp2Y85W+AzN3vgIF+a.wxeUHA5nsEjEzSu/+LDNWY6MAfKwyi0/pK1llOXMnRg=")
channel = LineChannel(k9,k9.server.CHANNEL_ID['LINE_TIMELINE'])
k9.log("Auth Token : " + str(k9.authToken))
print ("Welcome k10")  
#k10 = LineClient()
k10 = LineClient(authToken="EC3laffvBmHHvhrOluxe.j8up/jp5rc2Sm/RKgxPt3G.QznEZq0LG9U1bgELTHFOMjK0Dk0Tsp4+d7USA7O9i1E=")
channel = LineChannel(k10,k10.server.CHANNEL_ID['LINE_TIMELINE'])
k10.log("Auth Token : " + str(k10.authToken))
print ("Welcome login ghost")  
#sw = LineClient()
sw = LineClient(authToken="ECfxEAp7vMumbzKBUl5c.XDR01U1xqaAjYZzhlcTfVa.j7MTJiKaQ5zeRNb1C3Ea6qEMpd6jyi21KdHXj9E+i0k=")
